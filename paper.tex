...
\section{Methodology}
    ...
    profiling based methodology tools, e.g. perf \cite{perf}, lacking of high fidelity, all-recorded profiling result of
...
\section{Experiment}
    ...
    kernel version 4.4 and PREEMPT\textunderscore RT \cite{preemptrt} patches.
